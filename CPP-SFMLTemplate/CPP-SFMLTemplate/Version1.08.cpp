...
//Local Variables
	...
	/*Textures */ sf::Texture Screen, Plane, Bullet, StartScreen, PauseScreen, InstructionsScreen, LoseScreen, EnemyPlane;
	...
	sf::Vector2f BulletLocation(100,400);
				...
				if(gamestate == 1)
				{
					...
					//Background scroller
						if(ScreenLocation.y < 0)
							{
								ScreenLocation.y = ScreenLocation.y+0.001;
							}
						if(ScreenLocation.y > 0)
							{
