...
//Local Variables
	...
	sf::Vector2f EnemyPlane4Location(400,550);
		...
		//Character Icon Tip 1 Image Variables
	...
	//Character Icon Tip 2 Image Variables
	...
	//Character Icon Tip 3 Image Variables
	...
	EnemyPlane4Sprite.setPosition(EnemyPlane4Location.x,EnemyPlane4Location.y);
		...
		//Checks if Character is loaded from Assets Folder
	...
	CharacterIconTip1Image.setPosition(CharacterIconTip1Location.x,CharacterIconTip1Location.y);
		...
		//Checks if CharacterTip2 is loaded from Assets Folder
	...
	CharacterTip2Image.setPosition(CharacterTip2Location.x,CharacterTip2Location.y);
			...
			//Checks if CharacterTip3 is loaded from Assets Folder
...
while (TheGameWindow.isOpen()) 
			{
				...
				if(gamestate == 1)
				{
					// measure delta time since last game loop
					...
					{
						if(EnemyPlane2Location.x<150.1)
						{						
						L=6;
					...
					if(EnemyPlane3Location.x>150)
					{
						if(EnemyPlane3Location.x<150.1)
						{						
						L=6;
					...
					{
						if(EnemyPlane4Location.y<150.1)
						{						
						L=12;
