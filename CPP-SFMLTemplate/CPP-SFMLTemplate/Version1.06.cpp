...
//Local Variables
	...
	if (!Screen.loadFromFile("Assets/Screen.png")) //The Background Image...
		{
	...
	//pausescreen Image Variables
	if (!PauseScreen.loadFromFile("Assets/PauseScreen.png")) //The PauseScreen Image...
		{
		std::cout << "Screen has not loaded" << "\n";
		system("pause");
		}
	...
	//Bullet Image Variables
	if (!Bullet.loadFromFile("Assets/Bullet.png")) //The bullet Image...
		{
...
while (TheGameWindow.isOpen()) 
			{
				...
				if(gamestate == 1)
				{
					EnemyPlaneSprite.setPosition(300,200);
