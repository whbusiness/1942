...
//Local Variables
	...
	/*Textures */ sf::Texture Screen, Screen2, Plane, StartScreen, PauseScreen, InstructionsScreen, LoseScreen, EnemyPlane, EnemyPlane2, EnemyPlane3, EnemyPlane4;
	...
	Level2Text.setString("Level 2, Press Enter To Continue...");
	Level2Text.setPosition(20,180);
				...
				*/
					...
					if (move4)
					{
						...
						if(ScreenLocation.y < 0)
							{
								ScreenLocation.y = ScreenLocation.y+0.03;
							}
						if(ScreenLocation.y > 0)
							{
						...
						if(Screen2Location.y < 0)
							{
								Screen2Location.y = Screen2Location.y+0.03;
							}
						if(Screen2Location.y > 0)
							{
						...
						if(move12)
						{
							EnemyPlane4Location.x = 200;
							EnemyPlane4Location.y = 200;
							EnemyPlane4Sprite.setPosition(EnemyPlane4Location.x,EnemyPlane4Location.y);
							if((PlaneSprite.getGlobalBounds().intersects(EnemyPlane4Sprite.getGlobalBounds())))
							{
								EnemyPlane4Location.x = 220;
								EnemyPlane4Location.y = -50;
								EnemyPlane4Sprite.setPosition(EnemyPlane4Location.x,EnemyPlane4Location.y);
								move12 = false;
								move13 = true;
							}
						...
						if(move12)
						{
							...
							if (EnemyPlane4Location.y > 600)
							{
							EnemyPlane4Location.y = 0 - EnemyPlane4Height;
							}
							EnemyPlane4Sprite.setPosition(EnemyPlane4Location.x,EnemyPlane4Location.y);
						}
