...
unsigned short int WindowX = 500;
unsigned short int WindowY = 500;
	sf::RenderWindow TheGameWindow(sf::VideoMode(WindowX,WindowY),"1942",sf::Style::Titlebar); //sf::Style::Fullscreen || sf::Style::Titlebar, Fullscreen is not suitable
